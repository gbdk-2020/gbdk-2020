...
CLASS classes[] = {
    ...
    { .port         = "mos6502",
      ...
      .postproc     = "%mknes% -m 30 -n 0 -b 0 -a 1 $1 $2 $3",
    ...
    { .port         = "mos6502",
      ...
      .com          = "%com% %comdefault% -Wa%asdefault% $1 %comflag% -DNES_TILEMAP_S=1 -DNES_WINDOW_LAYER=1 $2 -o $3",
      .as           = "%as_6500% %asdefault% $1 $3 $2",
      .bankpack     = "%bankpack% -plat=nes -mapper=30 $1 $2",
      .ld           = "%ld_6808% -a nes -n -i -j $1 %libs_include% $3 %crt0dir% $2",
      .ihxcheck     = "%ihxcheck% $2 $1",
      .mkbin        = "%mkbin% -N -yo A $1 $2 $3",
      .postproc     = "%mknes% -m 30 -n 0 -b 1 -a 1 $1 $2 $3",
      .llist0_defaults    = llist0_defaults_nes,
      .llist0_defaults_len= ARRAY_LEN(llist0_defaults_nes),
    },
    ...
    { .port         = "mos6502",
      ...
      .com          = "%com% %comdefault% -Wa%asdefault% $1 %comflag% -DNES_TILEMAP_F=1 $2 -o $3",
      .as           = "%as_6500% %asdefault% $1 $3 $2",
      .bankpack     = "%bankpack% -plat=nes -mapper=30 $1 $2",
      .ld           = "%ld_6808% -a nes -n -i -j $1 %libs_include% $3 %crt0dir% $2",
      .ihxcheck     = "%ihxcheck% $2 $1",
      .mkbin        = "%mkbin% -N -yo A $1 $2 $3",
      .postproc     = "%mknes% -m 30 -n 1 -b 1 -a 1 $1 $2 $3",
      .llist0_defaults    = llist0_defaults_nes,
      .llist0_defaults_len= ARRAY_LEN(llist0_defaults_nes),
    },
    ...
    { .port         = "mos6502",
      ...
      .com          = "%com% %comdefault% -Wa%asdefault% $1 %comflag% -DNES_TILEMAP_H=1 $2 -o $3",
      .as           = "%as_6500% %asdefault% $1 $3 $2",
      .bankpack     = "%bankpack% -plat=nes -mapper=2 $1 $2",
      .ld           = "%ld_6808% -a nes -n -i -j $1 %libs_include% $3 %crt0dir% $2",
      .ihxcheck     = "%ihxcheck% $2 $1",
      .mkbin        = "%mkbin% -N -yo A $1 $2 $3",
      .postproc     = "%mknes% -m 2 -n 1 -b 0 -a 0 $1 $2 $3",
      .llist0_defaults    = llist0_defaults_nes,
      .llist0_defaults_len= ARRAY_LEN(llist0_defaults_nes),
    },
    ...
    { .port         = "mos6502",
      ...
      .com          = "%com% %comdefault% -Wa%asdefault% $1 %comflag% -DNES_TILEMAP_V=1 $2 -o $3",
      .as           = "%as_6500% %asdefault% $1 $3 $2",
      .bankpack     = "%bankpack% -plat=nes -mapper=2 $1 $2",
      .ld           = "%ld_6808% -a nes -n -i -j $1 %libs_include% $3 %crt0dir% $2",
      .ihxcheck     = "%ihxcheck% $2 $1",
      .mkbin        = "%mkbin% -N -yo A $1 $2 $3",
      .postproc     = "%mknes% -m 2 -n 0 -b 0 -a 0 $1 $2 $3",
      .llist0_defaults    = llist0_defaults_nes,
      .llist0_defaults_len= ARRAY_LEN(llist0_defaults_nes),
    }
};
