    ...
    while(1) {        
        ...
        if (hide)
            ...
            switch (rot) {
                ...
                case 1: hiwater = move_metasprite_hflip (sprite_metasprites[idx], 0, 0, (PosX >> 4),     (PosY >> 4) - 8); break;
                case 2: hiwater = move_metasprite_hvflip(sprite_metasprites[idx], 0, 0, (PosX >> 4) - 8, (PosY >> 4) - 8); break;
                case 3: hiwater = move_metasprite_vflip (sprite_metasprites[idx], 0, 0, (PosX >> 4) - 8, (PosY >> 4)    ); break;
            };
