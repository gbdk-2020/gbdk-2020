...
void main(void)
{
    ...
    DrawText(1,1,DEVICE_SCREEN_WIDTH-2,"This is an how you draw text on the screen in GBDK. The code will automatically jump to a new line, when it reaches the end of the row.",3);
}
